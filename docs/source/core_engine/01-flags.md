...
The Core Engine of DiffSync is meant to be transparent for most users but in some cases it's important to have the ability to change it's behavior to adjust to some specific use cases. For these use cases, there are few methods available to customize its behavior:
